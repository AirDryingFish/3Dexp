...
from util.datasets import build_shape_surface_occupancy_dataset_with_image_cond
...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/home/yangzengzhi/data_lht/3D ', type=str,
                        help='dataset path')
...
def main(args):
    ...
    dataset_train = build_shape_surface_occupancy_dataset_with_image_cond('train', args=args)
    dataset_val = build_shape_surface_occupancy_dataset_with_image_cond('val', args=args)
